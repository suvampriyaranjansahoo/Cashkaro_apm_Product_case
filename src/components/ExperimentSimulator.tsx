  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-4 rounded-2xl bg-white dark:bg-[#0E1726] border border-[#DCE4EE] dark:border-slate-800 shadow-xs mb-8">
          <div className="flex flex-wrap items-center gap-2">
            <Sliders className="w-4 h-4 text-[#316BEA] shrink-0" />
            <span className="text-xs font-semibold text-slate-700 dark:text-slate-300 font-display">Scenario Presets:</span>
          ...
          <button
            onClick={() => applyPreset('base')}
            className="text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white flex items-center gap-1 shrink-0 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-8">
          ...
          <div className="lg:col-span-6 bg-white dark:bg-[#0E1726] border border-[#DCE4EE] dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-5">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <span className="text-xs font-mono text-slate-400">Analyst Controls</span>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-slate-800 dark:text-slate-200">
                  Eligible Users (<span className="font-mono text-[#316BEA] dark:text-blue-400">E</span>)
                </label>
              ...
              <input
                ...
                className="w-full h-1.5 bg-slate-200 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-[#316BEA]"
              />
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-slate-800 dark:text-slate-200">
                  Expected Causal Lift (<span className="font-mono text-[#316BEA] dark:text-blue-400">ΔO</span>)
                </label>
                <span className="font-mono font-bold text-[#316BEA] dark:text-blue-300 bg-blue-50 dark:bg-blue-950/60 px-2 py-0.5 rounded">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center text-xs">
                <label className="font-semibold text-slate-800 dark:text-slate-200 flex items-center gap-1">
                  ...
                  <span className="text-[10px] text-slate-400 font-normal">(Safety deduction)</span>
                </label>
            ...
            <div className="grid grid-cols-2 gap-4 pt-3 border-t border-slate-100 dark:border-slate-800">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full text-xs font-mono p-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white focus:ring-1 focus:ring-[#316BEA]"
                />
              </div>
          ...
          <div className="lg:col-span-6 space-y-4">
            ...
            <div className={`rounded-2xl p-6 border shadow-md transition-all ${
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                ...
                <div>
                  <div className="text-[10px] text-slate-400">Net Tracked Orders</div>
                  <div className="text-lg sm:text-xl font-bold font-mono text-blue-300 mt-0.5">
                    +{netIncrementalOrders.toLocaleString()}
                  </div>
                  <div className="text-[10px] text-slate-400">After Haircut</div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-[10px] text-slate-400">₹{netContributionPerOrder}/order</div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-black/40 border border-white/10 space-y-2.5">
                <div className="flex justify-between items-center text-xs">
                  <span className="text-slate-300">Total Q1 Investment (Kf + Kr1):</span>
                  <span className="font-mono font-semibold text-slate-200">₹{totalCost.toLocaleString()}</span>
                </div>

                <div className="flex justify-between items-center text-xs">
                  <span className="text-slate-300">Break-Even Required Lift (ΔO_be):</span>
                  <span className="font-mono font-bold text-amber-300">+{breakEvenDeltaO.toFixed(2)} orders/user</span>
                </div>
                ...
                <div className="flex justify-between items-center text-sm pt-2.5 border-t border-white/10">
                  ...
                  <span className={`font-mono font-extrabold text-lg ${isProfitable ? 'text-emerald-400' : 'text-rose-400'}`}>
            ...
            <div className="p-4 rounded-xl bg-white dark:bg-[#0E1726] border border-[#DCE4EE] dark:border-slate-800 shadow-xs text-xs space-y-2">
